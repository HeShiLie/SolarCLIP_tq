...
def parse_args():
    ...
    parser.add_argument("--checkpoint_path", type=str,
                        default="/mnt/nas/home/huxing/202407/ctf/SolarCLIP_tq/checkpoints/recon/unetlike/", help="The output path to save the model.")
            ...
            with torch.no_grad():
                ...
                for i, data in enumerate(val_loader):
                    ...
                    if args.decoder_modal == 'magnet-0094':
                        ...
                        modal_2 = modal
                    weights, _ = get_weights(args.weight_type, modal_2)
                    mse_weight, mse = SolarReconModel.calculate_loss(modal, modal_2, weights)
