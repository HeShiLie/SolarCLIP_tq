...
from Model.SolarReconModels.Pos_CLIP.SolarReconModel_Pos_CLIP_LinearDecoder import get_SolarReconModel_from_args
...
def parse_args():
    ...
    parser.add_argument("--checkpoint_path", type=str,
                        default="/mnt/nas/home/huxing/202407/ctf/SolarCLIP_tq/checkpoints/recon/LinearDecoder/", help="The output path to save the model.")
...
def train(args, train_loader, val_loader):
    ...
    SolarReconModel = get_SolarReconModel_from_args(args).to(device)
    if args.vit_pretrain:
