...
def main():
    ...
    end_date = transfer_date_to_id(2015, 6, 30)
    ...
    checkpoint_path = f'/mnt/tianwen-tianqing-nas/tianwen/home/202407/ctf/SolarCLIP/checkpoints/pretrain/{modal}/{enhance_ls[0]}/'
