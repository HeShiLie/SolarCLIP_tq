...
def get_modal_dir(modal, date_id, y_start=2010, m_start=5, d_start=1, y_end=2024, m_end=7, d_end=1):
    ...
    if modal == 'magnet':
        path_pt = f"/mnt/tianwen-tianqing-nas/tianwen/home/202407/data_tar/hmi/magnet_pt/{date_str_1}/hmi.M_720s.{date_str_2}_{formatted_hours}{formatted_minutes}00_TAI.pt"
        ...
        path_pt = f"/mnt/tianwen-tianqing-nas/tianwen/home/202407/data_tar/spectral/0094_pt/{date_str_1}/AIA{date_str_2}_{formatted_hours}{formatted_minutes}_0094.pt"
