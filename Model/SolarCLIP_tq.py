...
class SolarCLIP_MODEL(nn.Module):
    ...
    def forward(self, image_mag, image_H, token_weight_1=1, token_weight_2=1, weights_type = '3sigma-discrete'):
        ...
        if self.transformer_token_type == 'class embedding':
            ...
            if token_weight_1 is None:
                ...
                token_weight_1, _ = get_weights(weights_type, image_mag)
            if token_weight_2 is None:
                ...
                token_weight_2, _ = get_weights(weights_type, image_H)
